...
export default function KDSScreen() {
  const { kdsOrders, isLoading, loadOrders, updateOrder } = useData();
  ...
  const getTimeColor = (minutes) => {
    if (minutes > 30) return '#ef4444'; // Red for very late
    if (minutes > 15) return '#f59e0b'; // Orange for late
      ...
      >
        {activeOrders.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyStateText}>No kitchen orders</Text>
              ...
              return (
                ...
                >
                  ...
                  <View style={styles.kitchenItems}>
                    <Text style={styles.sectionTitle}>🍽️ Kitchen Items</Text>
                    {order.items
